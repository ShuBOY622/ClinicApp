                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div></div>
                                <Input label="भाजी १ नाव / Bhaji 1 Name" name={`weeklyPlan.${activeDay}.slot2.curry1Name`} register={register} />
                                <Input label="भाजी १ मात्रा / Bhaji 1 Qty" name={`weeklyPlan.${activeDay}.slot2.curry1Qty`} register={register} />
                                <Input label="भाजी २ नाव / Bhaji 2 Name" name={`weeklyPlan.${activeDay}.slot2.curry2Name`} register={register} />
                                <Input label="भाजी २ मात्रा / Bhaji 2 Qty" name={`weeklyPlan.${activeDay}.slot2.curry2Qty`} register={register} />
                                <Input label="भाजी ३ नाव / Bhaji 3 Name" name={`weeklyPlan.${activeDay}.slot2.curry3Name`} register={register} />
                                <Input label="भाजी ३ मात्रा / Bhaji 3 Qty" name={`weeklyPlan.${activeDay}.slot2.curry3Qty`} register={register} />
                                <Input label="इतर / Other" name={`weeklyPlan.${activeDay}.slot2.other`} register={register} />
                                <Input label="भाकरी प्रकार / Type of Roti" name={`weeklyPlan.${activeDay}.slot2.rotiType`} register={register} />
                                <Input label="अन्न / Food" name={`weeklyPlan.${activeDay}.slot2.food`} register={register} />
                                <div></div>
                            </div>
                        </div>
                        ...
                        <div className="bg-green-50 rounded-xl p-6 border border-green-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div></div>
                                <Input label="भाजी १ नाव / Bhaji 1 Name" name={`weeklyPlan.${activeDay}.slot3.curry1Name`} register={register} />
                                <Input label="भाजी १ मात्रा / Bhaji 1 Qty" name={`weeklyPlan.${activeDay}.slot3.curry1Qty`} register={register} />
                                <Input label="भाजी २ नाव / Bhaji 2 Name" name={`weeklyPlan.${activeDay}.slot3.curry2Name`} register={register} />
                                <Input label="भाजी २ मात्रा / Bhaji 2 Qty" name={`weeklyPlan.${activeDay}.slot3.curry2Qty`} register={register} />
                                <Input label="भाजी ३ नाव / Bhaji 3 Name" name={`weeklyPlan.${activeDay}.slot3.curry3Name`} register={register} />
                                <Input label="भाजी ३ मात्रा / Bhaji 3 Qty" name={`weeklyPlan.${activeDay}.slot3.curry3Qty`} register={register} />
                                <Input label="इतर / Other" name={`weeklyPlan.${activeDay}.slot3.other`} register={register} />
                                <Input label="भाकरी प्रकार / Type of Roti" name={`weeklyPlan.${activeDay}.slot3.rotiType`} register={register} />
                                <Input label="अन्न / Food" name={`weeklyPlan.${activeDay}.slot3.food`} register={register} />
                                <div></div>
                            </div>
                        </div>
                        ...
                        <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div></div>
                                <Input label="भाजी १ नाव / Bhaji 1 Name" name={`weeklyPlan.${activeDay}.slot4.curry1Name`} register={register} />
                                <Input label="भाजी १ मात्रा / Bhaji 1 Qty" name={`weeklyPlan.${activeDay}.slot4.curry1Qty`} register={register} />
                                <Input label="भाजी २ नाव / Bhaji 2 Name" name={`weeklyPlan.${activeDay}.slot4.curry2Name`} register={register} />
                                <Input label="भाजी २ मात्रा / Bhaji 2 Qty" name={`weeklyPlan.${activeDay}.slot4.curry2Qty`} register={register} />
                                <Input label="भाजी ३ नाव / Bhaji 3 Name" name={`weeklyPlan.${activeDay}.slot4.curry3Name`} register={register} />
                                <Input label="भाजी ३ मात्रा / Bhaji 3 Qty" name={`weeklyPlan.${activeDay}.slot4.curry3Qty`} register={register} />
                                <Input label="इतर / Other" name={`weeklyPlan.${activeDay}.slot4.other`} register={register} />
                                <Input label="भाकरी प्रकार / Type of Roti" name={`weeklyPlan.${activeDay}.slot4.rotiType`} register={register} />
                                <Input label="अन्न / Food" name={`weeklyPlan.${activeDay}.slot4.food`} register={register} />
                                <div></div>
                            </div>
                        </div>
                        ...
                        <div className="bg-indigo-50 rounded-xl p-6 border border-indigo-100">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div></div>
                                <Input label="भाजी १ नाव / Bhaji 1 Name" name={`weeklyPlan.${activeDay}.slot5.curry1Name`} register={register} />
                                <Input label="भाजी १ मात्रा / Bhaji 1 Qty" name={`weeklyPlan.${activeDay}.slot5.curry1Qty`} register={register} />
                                <Input label="भाजी २ नाव / Bhaji 2 Name" name={`weeklyPlan.${activeDay}.slot5.curry2Name`} register={register} />
                                <Input label="भाजी २ मात्रा / Bhaji 2 Qty" name={`weeklyPlan.${activeDay}.slot5.curry2Qty`} register={register} />
                                <Input label="भाजी ३ नाव / Bhaji 3 Name" name={`weeklyPlan.${activeDay}.slot5.curry3Name`} register={register} />
                                <Input label="भाजी ३ मात्रा / Bhaji 3 Qty" name={`weeklyPlan.${activeDay}.slot5.curry3Qty`} register={register} />
                                <Input label="इतर / Other" name={`weeklyPlan.${activeDay}.slot5.other`} register={register} />
                                <Input label="भाकरी प्रकार / Type of Roti" name={`weeklyPlan.${activeDay}.slot5.rotiType`} register={register} />
                                <Input label="अन्न / Food" name={`weeklyPlan.${activeDay}.slot5.food`} register={register} />
                                <div></div>
                            </div>
                        </div>
                    </div>
