                ...
                <div className="prescription-section">
                    ...
                    <div className="examination-grid">
                        <div className="exam-row">
                            ...
                            <span className="label">{isMarathi ? 'दक्षिण वक्ष' : 'Right Chest'}:</span>
                            <span className="underline"></span>
                        </div>
                        <div className="exam-row">
                            <span className="label">{isMarathi ? 'प्लीहा' : 'Spleen'}:</span>
                            <span className="underline"></span>
                            <span className="label">{isMarathi ? 'वाम वक्ष' : 'Left Chest'}:</span>
                            <span className="underline"></span>
                        </div>
                        <div className="exam-row">
                            <span className="label">{isMarathi ? 'अपानकक्षा' : 'Appendix'}:</span>
                            <span className="underline"></span>
                        </div>
                    </div>
                </div>
